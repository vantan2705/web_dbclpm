...
function getRandomColors(numberOfColor) {
    var colors = [];
    for (var i = 0; i < numberOfColor; i++) {
        colors.push(randomMaterialColor());
    }
    return colors;
}

function getListSameColors(numberOfColor) {
    var colors = [];
    var color = randomMaterialColor();
    for (var i = 0; i < numberOfColor; i++) {
        colors.push(color);
    }
    return colors;
...
function getListDefaultColor(numberOfColor) {
    var colors = [];
    var color = "#2196f3";
    for (var i = 0; i < numberOfColor; i++) {
        colors.push(color);
...
function getListRandomInteger(numberOfInt, min, max) {
    var numbers = [];
    for (var i = 0; i < numberOfInt; i++) {
